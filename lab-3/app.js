        ...
        function equalizeHistogram() {
            ...
            for (let i = 0; i < data.length; i += 4) {
                ...
                data[i] = Math.min(255, Math.max(0, data[i] * scaleFactor));     
                data[i + 1] = Math.min(255, Math.max(0, data[i + 1] * scaleFactor)); 
                data[i + 2] = Math.min(255, Math.max(0, data[i + 2] * scaleFactor)); 
            }
