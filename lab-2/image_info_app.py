...
class ImageInfoExtractor:
    ...
    def _get_color_depth(self, mode):
        """Определяет глубину цвета на основе режима изображения"""
        depth_map = {
    ...
    def _get_compression(self, img, file_path):
    ...
    def _get_compression_from_info(self, info_dict):
        ...
        try:
                ...
                if key in info_dict:
                    ...
                    if value:
                        if isinstance(value, int):
                            ...
                            return compression_codes.get(value, f'Code {value}')
                        else:
                            return str(value)
            ...
            if 'jfif' in info_dict:
                ...
                return "JPEG (Adobe)"
            elif 'progressive' in info_dict:
                return "JPEG (прогрессивный)"
    ...
    def _get_format_specific_info(self, img, file_path):
        """Извлекает специфическую информацию для разных форматов"""
        format_specific = {}
...
class ImageInfoApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Анализатор графических файлов v2.2")
    ...
    def setup_ui(self):
        ...
        self.tree.column('color_depth', width=100, anchor=tk.CENTER)
    ...
    def scan_folder(self):
        """Сканирует выбранную папку на наличие графических файлов"""
